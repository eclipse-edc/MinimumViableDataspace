...
From the `Registration Service` root folder, execute the following commands:
...
Generated keys are imported to keystores e.g. `system-tests/resources/vault/company1/company1-keystore.jks`. Each keystore has password `test123`.
