...
public class MembershipCredentialEvaluationFunction implements AtomicConstraintFunction<Permission> {
    ...
    private static final String MEMBERSHIP_CLAIM = "http://org.yourdataspace.com#membership";
    private static final String MEMBERSHIP_SINCE_CLAIM = "http://org.yourdataspace.com#since";
